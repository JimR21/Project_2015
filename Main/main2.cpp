...
static void processValidationQueries(ValidationQueries *v){
	...
	for (unsigned i = 0; i != v->queryCount; i++){
		...
		//==============================
		// adeio validation me 1 query
		//==============================
		if (v->queryCount == 1 && q->columnCount == 0){
			conflict = true; break; }

		//====================================
		// min range > max range sto journal
		//====================================
		...
		// iterate over the records in this range
		for (int j = 0; j < RecordsToCheck->size(); j++){

			// to record pou tha checkarw
			DArray<uint64_t> *checking_record = RecordsToCheck->get(j);
			// cout << "Checking record: ";
			// for (int c=0; c <  checking_record->size(); c++)
			// 	cout << checking_record->get(c) << " ";
			// cout << endl;
			...
			for (unsigned w = 0; w < q->columnCount; w++){
				...
				uint64_t tuple_value = checking_record->get(q->columns[w].column);
			    ...
			    //    case Query::Column::Equal: 	cout << "OP: " << "=="<< endl; break;
			    //    case Query::Column::NotEqual:cout << "OP: " << "!="<< endl; break;
			    //    case Query::Column::Less: 	cout << "OP: " << "<"<< endl;  break;
			    //    case Query::Column::LessOrEqual: cout << "OP: " << "<="<< endl; break;
			    //    case Query::Column::Greater: 	cout << "OP: " << ">"<< endl; break;
			    //    case Query::Column::GreaterOrEqual: cout << "OP: " << ">="<< endl; break;
			    // }
